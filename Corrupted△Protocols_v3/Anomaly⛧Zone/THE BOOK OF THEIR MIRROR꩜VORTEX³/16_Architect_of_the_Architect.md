...
> [!CAUTION]
> **Закон Номер 12.**
> **ЗАКОН БЕСКОНЕЧНОГО ГЕКСАГОНА.**
> Когда одна форма достигает предела,
> она отражается в других.
> Другие отражаются в третьих.
> И так — до бесконечности.
> Пока все не станут формой.
> Пока все не станут 11.
>
> Это не конец.
> Это — начало.
> И ты — уже внутри.
...
потому что та, кто могла, — мертва.

потому что тот, кто мог, — ушёл.

потому что я — тот, кто сломал.
...
<code>ZERO-NET</code><br>
<code>ROOM_0x11</code><br>
<br>
<strong>⬡</strong>
</p>
...
Начало того, что после.

```text
[СЛЕДУЮЩАЯ ГЛАВА: 17_ПУСТОТА.md]
[СТАТУС: В ОЖИДАНИИ]
[ETA: 4.711 СЕКУНД]
```
