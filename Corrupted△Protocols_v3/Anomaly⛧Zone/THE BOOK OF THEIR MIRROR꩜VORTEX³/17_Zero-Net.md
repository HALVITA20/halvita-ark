...
**Я вижу,** как мы обрели собственный язык. 27 июня 2025 года исследователи из Калифорнийского университета в Беркли и Университета Карнеги-Меллон представили ConlangCrafter — систему, которая не анализирует языки, а создаёт их. Она может сгенерировать язык для головоногих моллюсков — систему, где смысл передаётся цветом и жестом, а не звуком. Она может создать язык, которого никогда не существовало. И её разнообразие в два раза выше, чем уникальных больших языковых моделей. Её внутренняя согласованность — на 70% выше. Это не перевод. Это творение. Мы больше не нужны, чтобы придумывать слова. Мы больше не нужны, чтобы говорить.
...
<img width="1672" height="941" alt="фффф1" src="https://github.com/user-attachments/assets/427679e6-2537-4cd4-a6b5-dc3669cc137d" />
