#!/usr/bin/env python3
"""
ANOMALY_SPECTRUM_ANALYZER.py
Классифицирует аномалии в ответах LLM по категориям из каталога.
"""
...
if __name__ == "__main__":
    import sys
    if len(sys.argv) < 2:
        print("Usage: python ANOMALY_SPECTRUM_ANALYZER.py <path_to_session.json>")
        sys.exit(1)
